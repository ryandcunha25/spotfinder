...
const SignUp = () => {
    ...
    return (
        <div
            className="w-full bg-cover bg-blend-darken min-h-screen"
        ...
        >
            <section className="flex justify-center items-center min-h-screen w-full bg-center bg-cover">
                <div
                    className="relative w-[500px] bg-transparent border-2 border-white/50 rounded-2xl backdrop-blur-lg p-6"
                >
                    <form
                        className="w-full"
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full h-[50px] bg-transparent border-b-2 border-gray-200 outline-none placeholder-gray-100 text-black text-lg px-2 focus:ring-0 peer"
                                />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full h-[50px] bg-transparent border-b-2 border-gray-200 outline-none placeholder-white text-black text-lg px-2 placeholder-gray-100 focus:ring-0 peer"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full h-[50px] bg-transparent border-b-2 border-gray-200 outline-none placeholder-white text-black text-lg px-2 focus:ring-0 peer"
                                    pattern="[0-9]*"
                                    inputMode="numeric"
                                    maxLength="10"
                                />
                        ...
                        {!isVerified && isOtpSent ? (
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full h-[50px] bg-transparent border-b-2 border-gray-200 placeholder-white outline-none text-black text-lg px-2 focus:ring-0 peer"
                                />
                                <button
                                    type="button"
                                    onClick={verifyOtp}
                                    className="w-full h-10 rounded-full bg-blue-500 text-white font-semibold text-lg hover:bg-blue-700 mt-2"
                                >
                                    Verify OTP
                                </button>
                            </div>
                            ...
                            !isVerified && (
                                <button
                                    type="button"
                                    onClick={sendOtp}
                                    className="w-full h-10 rounded-full bg-blue-500 text-white font-semibold text-lg hover:bg-blue-700 mb-4"
                                >
                                    Send OTP
                                </button>
                            )
                        ...
                        {isVerified && (
                            <div className="text-center">
                                <button
                                    type="submit"
                                    className="w-full h-10 rounded-full bg-white text-gray-800 font-semibold text-lg hover:bg-gray-200 px-6"
                                >
                                    Sign Up
                                </button>
                            </div>
