        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="font-medium text-gray-700">₹{booking.total_price}</span>
            </div>
    ...
    return (
      <div className="mb-6">
        <button
          ...
          className={`w-full flex justify-between items-center p-4 rounded-lg transition-colors duration-200 ${
            isExpanded ? "bg-blue-600 text-white" : "bg-gray-100 hover:bg-gray-200 text-gray-800"
          }`}
        >
          <div className="flex items-center">
